...
Reduce the font size and checkbox size for a more compact appearance.
...
<div class="input input-dense">
  ...
  <div class="input_control checkboxes">
    <div class="checkbox">
      <input type="checkbox" id="dense_1" value="dense_1" class="checkbox_control" />
      <label for="dense_1" class="checkbox_label">Option 1</label>
    </div>
    <div class="checkbox">
      <input type="checkbox" id="dense_2" value="dense_2" class="checkbox_control" />
      <label for="dense_2" class="checkbox_label">Option 2</label>
    </div>
  </div>
</div>
```
...
<div class="input">
  ...
  <div class="input_control checkboxes">
    <div class="checkbox">
      <input type="checkbox" id="hideLabel_1" value="hideLabel_1" class="checkbox_control" />
      <label for="hideLabel_1" class="checkbox_label">Option 1</label>
    </div>
    <div class="checkbox">
      <input type="checkbox" id="hideLabel_2" value="hideLabel_2" class="checkbox_control" />
      <label for="hideLabel_2" class="checkbox_label">Option 2</label>
    </div>
  </div>
</div>
```
