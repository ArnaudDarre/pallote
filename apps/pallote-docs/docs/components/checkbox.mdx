...
<div class="docs_block">
  <Checkbox id="dense" value="dense" label="Dense" dense />
</div>
...
```html
<div class="checkbox checkbox-dense">
  <input type="checkbox" id="dense" value="dense" class="checkbox_control" />
  <label for="dense" class="checkbox_label">Dense</label>
</div>
```
  </TabItem>
</Tabs>
