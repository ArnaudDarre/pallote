...
<div class="docs_block">
  ...
  <NavItem label='Home' active href='' />
    <NavItem
      ...
      dropdown={
        <>
          <NavItem label='Services' href='' />
          <NavItem label='Teams' href='' />
        </>
      }
    />
...
<NavBar
  logo={
    <Link to="/" exact>
      <img
        src="/pallote-logo.svg"
        alt="Logo for Pallote"
      />
    </Link>
  }
>
  <NavItem label='Home' active component={Link} to='' />
  <NavItem
    label='About'
    dropdown={
      <>
        <NavItem label='Services' component={Link} to='' />
        <NavItem label='Teams' component={Link} to='' />
      </>
    }
  />
  <NavItem label='Contact' component={Link} to='' />
</NavBar>
```
  </TabItem>
    ...
    <div class="section_container">
      <div class="navbar_main">
        <a href="/" class="navbar_logo">
          <img alt="Logo for Pallote" src="/logos-logo.svg">
        </a>
...
<div class="docs_block">
  ...
  >
    <NavItem label='Align' active href='' />
    <NavItem label='Start' href='' />
  </NavBar>
  <NavBar
    logo={
      <a href="/">
...
<header>
  <div class="section navbar navbar-end">
    <div class="section_container">
      <div class="navbar_main">
        <a href="/" class="navbar_logo">
          <img alt="Logo for Pallote" src="/logos-logo.svg">
