...
Defines a section on a page. A section will always have one [SectionHeader](/docs/components/section-header.mdx) and at least one [SectionContent](/docs/components/section-content.mdx) child component.
...
Change the elements and texts alignement inside the component. You can override that setup for individual [SectionContent](/docs/components/section-content.mdx) components.
...
<div class="section section-secondary">
  <div class="section_container">
    <div class="section_header">
      <p class="section_title">Background secondary</p>
      <p class="section_subtitle">Change the background colour to secondary</p>
    </div>
  </div>
</div>
<div class="section section-secondaryLight">
  <div class="section_container">
    <div class="section_header">
      <p class="section_title">Background secondary-light</p>
      <p class="section_subtitle">Change the background colour to secondary light</p>
    </div>
  </div>
</div>
```
