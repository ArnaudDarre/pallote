...
<div class="docs_block">
  <RadioButtons label="Hint" hint="This is a hint to give more details">
...
<div class="input">
  ...
  <div class="input_control radios">
    <div class="radio">
      <input type="radio" name="hint" id="hint_1" value="hint_1" class="radio_control" />
      <label for="hint_1" class="radio_label">Option 1</label>
    </div>
    <div class="radio">
      <input type="radio" name="hint" id="hint_2" value="hint_2" class="radio_control" />
      <label for="hint_2" class="radio_label">Option 2</label>
    </div>
  </div>
</div>
```
...
<div class="input input-dense">
  <legend class="input_label">Dense</legend>
  <div class="input_control radios">
    <div class="radio">
      <input type="radio" name="dense" id="dense_1" value="dense_1" class="radio_control" />
      <label for="dense_1" class="radio_label">Option 1</label>
    </div>
    <div class="radio">
      <input type="radio" name="dense" id="dense_2" value="dense_2" class="radio_control" />
      <label for="dense_2" class="radio_label">Option 2</label>
    </div>
  </div>
</div>
```
...
```html
<div class="input">
  <legend class="input_label sr-only">Hidden Label</legend>
  <div class="input_control radios">
    <div class="radio">
      <input type="radio" name="hideLabel" id="hideLabel_1" value="hideLabel_1" class="radio_control" />
      <label for="hideLabel_1" class="radio_label">Option 1</label>
    </div>
    <div class="radio">
      <input type="radio" name="hideLabel" id="hideLabel_2" value="hideLabel_2" class="radio_control" />
      <label for="hideLabel_2" class="radio_label">Option 2</label>
    </div>
  </div>
</div>
```
